  ...
  return (
    <div>
      ...
      <div className="lk-container">
        <h1 className="lk-section__title my-direction__title">Мое направление</h1>
        <div className="user">
          ...
          <div className="user__info">
            <h2 className="full-name">Иванов Иван Васильевич</h2>
            <div className="user__data">
              <ul className="list-reset data__keys">
                <li className="data__key">&#8470; студенческого билета:</li>
                <li className="data__key">Группа:</li>
                <li className="data__key">Электронная почта:</li>
                <li className="data__key">Мое направление:</li>
              </ul>
        ...
        <ul className="list-reset mentors-list">
          <li className="mentors__item"><MentorCard /></li>
          <li className="mentors__item"><MentorCard /></li>
          <li className="mentors__item"><MentorCard /></li>
          <li className="mentors__item"><MentorCard /></li>
        </ul>
